...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('refund_requests', function (Blueprint $table): void {
            ...
            $table->foreign('requested_by_platform_admin_id')->references('id')->on('platform_admins')->restrictOnDelete();
        ...
        Schema::create('payment_reconciliation_alerts', function (Blueprint $table): void {
            ...
            $table->foreign('subscription_id')->references('id')->on('subscriptions')->restrictOnDelete();
            $table->foreign('payment_id')->references('id')->on('payments')->restrictOnDelete();
            $table->foreign('reviewed_by_platform_admin_id')->references('id')->on('platform_admins')->nullOnDelete();
            $table->foreign('corrected_by_platform_admin_id')->references('id')->on('platform_admins')->nullOnDelete();
            $table->foreign('audit_event_id')->references('id')->on('platform_audit_events')->nullOnDelete();
