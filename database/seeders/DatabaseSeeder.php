    ...
    public function run(): void
    {
        ...
        $modules = [
            'law' => [
                ...
                'expedicoes' => ['Controle de Expedições', 4.90, 'expedientes', 'expedicoes', false],
        ...
        $plans = [
            'law' => [
                ...
                'law-cartorio-criminal' => ['Cartório Criminal', null, ['processos-criminal', 'partes-cartorio', 'expedicoes', 'audiencias-cartorio', 'agenda-cartorio', 'presos', 'monitoramento', 'medidas', 'penas', 'relatorios-operacionais', 'notificacoes']],
                'law-cartorio-civel' => ['Cartório Cível', null, ['processos-civel', 'partes-cartorio', 'expedicoes', 'custas', 'audiencias-cartorio', 'agenda-cartorio', 'prazos-civel', 'relatorios-operacionais', 'relatorios-juridicos', 'notificacoes']],
                ...
                'law-gestao-expedientes' => ['Gestão de Expedientes', null, ['processos-expedientes', 'expedicoes', 'documentos', 'tarefas-expedientes', 'prazos-expedientes', 'assinatura-digital', 'relatorios-operacionais', 'notificacoes']],
            ],
            'lead' => [
