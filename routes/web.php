...
Route::get('/backoffice/{page?}', fn () => response()->file(public_path('backoffice/index.html')))->where('page', 'painel|empresas|planos|catalogo|assinaturas|vouchers|pagamentos|billing|seguranca|interesses|product-interests');
