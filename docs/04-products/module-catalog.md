...
Este arquivo lista os modulos previstos, em planejamento ou implementados.
...
| Backoffice | Fokus Cloud | Em evolucao | Administracao interna da plataforma para catalogo comercial, assinaturas, vouchers, indicadores financeiros e auditoria. |
| Fokus Law - Gestao de Processos | Fokus Law | V1 definida | Nucleo tecnico `processos`, oferecido para advocacia, Judiciario e setor publico conforme segmento e contexto. Menu: Processos. |
| Fokus Law - Gestao de Contatos | Fokus Law | V1 definida | Nucleo tecnico `contatos`, com variantes para advogados, Judiciario e setor publico. Menu: Contatos. |
