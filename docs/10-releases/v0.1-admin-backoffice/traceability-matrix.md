...
| 2 | Seguranca interna | `../../04-products/backoffice.md`, `../../05-requirements/backoffice.md`, `../../07-security/access-control-policy.md` | Login interno, MFA, bloqueio rigido, perfis e guard separado | Testes de autenticacao, isolamento, bloqueio e permissao |
| 3 | Catalogo administrativo | `../../08-commercial/catalog.md`, `../../08-commercial/catalog-api.md`, `../../06-data/catalog-data-model.md` | CRUD de catalogo, publicacao controlada e consumo pelo catalogo publico | Testes de rascunho, publicado, pausado, arquivado e checkout |
