...
O arquivo `public/src/assets/js/subscription-catalog.js` contem uma copia estatica de sistemas, planos, funcionalidades e precos. Essa copia pode divergir do banco e nao deve continuar sendo fonte comercial.
