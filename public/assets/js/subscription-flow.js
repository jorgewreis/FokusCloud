(() => {
  ...
  function accountView() {
    ...
    const content = isRegister
      ? `<p>Cadastre a empresa e o administrador responsável. Após confirmar o e-mail, você retorna para concluir esta assinatura.</p><form id="subscription-register-form"><label class="form-field"><span class="fs-form-label">Tipo de documento</span><select class="field-size-md" name="document_type" id="subscription-document-type"><option value="cnpj">CNPJ</option><option value="cpf">CPF</option></select></label><label class="form-field"><span class="fs-form-label">CPF ou CNPJ</span><input class="field-size-md" name="document_number" id="subscription-company-document" inputmode="numeric" required><span class="field-error" id="subscription-company-document-error" role="alert"></span></label><label class="form-field"><span class="fs-form-label" id="subscription-company-name-label">Razão social</span><input class="field-size-md" name="legal_name" required></label><label class="form-field"><span class="fs-form-label">Nome completo do administrador</span><input class="field-size-md" name="name" autocomplete="name" required></label><label class="form-field"><span class="fs-form-label">CPF do administrador</span><input class="field-size-md" name="cpf" id="subscription-admin-cpf" inputmode="numeric" autocomplete="username" required><span class="field-error" id="subscription-admin-cpf-error" role="alert"></span></label><label class="form-field"><span class="fs-form-label">E-mail profissional</span><input class="field-size-md" name="email" type="email" autocomplete="email" required></label><label class="form-field"><span class="fs-form-label">Senha</span><input class="field-size-md" name="password" type="password" autocomplete="new-password" minlength="12" required></label><label class="consent-field"><input type="checkbox" name="terms" required><span>Li e aceito os Termos de Uso.</span></label><label class="consent-field"><input type="checkbox" name="privacy" required><span>Li e aceito a Política de Privacidade.</span></label></form><div class="login-actions"><button class="fs-btn fs-btn-success" form="subscription-register-form" type="submit">Criar conta e continuar</button></div><p id="account-feedback" class="form-message" role="status"></p><small>Já tem conta? Use a aba <b>Entrar</b> para continuar com uma empresa existente.</small>`
      : `<p>Entre com CPF e senha para assinar este produto usando uma empresa já cadastrada.</p><form id="subscription-login-form"><label class="form-field"><span class="fs-form-label">CPF</span><input class="field-size-md" id="subscription-login-cpf" name="cpf" inputmode="numeric" autocomplete="username" required><span class="field-error" id="subscription-login-cpf-error" role="alert"></span></label><label class="form-field"><span class="fs-form-label">Senha</span><input class="field-size-md" name="password" type="password" autocomplete="current-password" required></label></form><div class="login-actions"><button class="fs-btn fs-btn-success" form="subscription-login-form" type="submit">Entrar e continuar</button></div><p id="account-feedback" class="form-message" role="status"></p><small>Se sua conta possuir mais de uma empresa, você escolherá qual delas será usada antes de continuar.</small>`;
    return `<div class="auth-card"><div class="fs-tabs"><button data-account="register" class="${isRegister ? "selected" : ""}">Criar conta da empresa</button><button data-account="login" class="${!isRegister ? "selected" : ""}">Entrar</button></div>${content}</div>`;
  }
