(() => {
  ...
  function accountView() {
    ...
    const content = isRegister
      ...
      : `<p>Entre com CPF e senha para assinar este produto usando uma empresa já cadastrada.</p><form id="subscription-login-form"><label>CPF<input id="subscription-login-cpf" name="cpf" inputmode="numeric" autocomplete="username" required><span class="field-error" id="subscription-login-cpf-error" role="alert"></span></label><label>Senha<input name="password" type="password" autocomplete="current-password" required></label><button class="btn btn-green" type="submit">Entrar e continuar</button></form><p id="account-feedback" role="status"></p><small>Se sua conta possuir mais de uma empresa, você escolherá qual delas será usada antes de continuar.</small>`;
