(() => {
  ...
  function accountView() {
    ...
    const content = isRegister
      ? `<p>Cadastre a empresa e o administrador responsável. Após confirmar o e-mail, você retorna para concluir esta assinatura.</p><form id="subscription-register-form"><label class="form-field"><span class="form-label">Tipo de documento</span><select name="document_type" id="subscription-document-type"><option value="cnpj">CNPJ</option><option value="cpf">CPF</option></select></label><label class="form-field"><span class="form-label">CPF ou CNPJ</span><input name="document_number" id="subscription-company-document" inputmode="numeric" required><span class="field-error" id="subscription-company-document-error" role="alert"></span></label><label class="form-field"><span class="form-label" id="subscription-company-name-label">Razão social</span><input name="legal_name" required></label><label class="form-field"><span class="form-label">Nome completo do administrador</span><input name="name" autocomplete="name" required></label><label class="form-field"><span class="form-label">CPF do administrador</span><input name="cpf" id="subscription-admin-cpf" inputmode="numeric" autocomplete="username" required><span class="field-error" id="subscription-admin-cpf-error" role="alert"></span></label><label class="form-field"><span class="form-label">E-mail profissional</span><input name="email" type="email" autocomplete="email" required></label><label class="form-field"><span class="form-label">Senha</span><input name="password" type="password" autocomplete="new-password" minlength="12" required></label><label class="consent-field"><input type="checkbox" name="terms" required><span>Li e aceito os Termos de Uso.</span></label><label class="consent-field"><input type="checkbox" name="privacy" required><span>Li e aceito a Política de Privacidade.</span></label><button class="btn btn-green" type="submit">Criar conta e continuar</button></form><p id="account-feedback" role="status"></p><small>Já tem conta? Use a aba <b>Entrar</b> para continuar com uma empresa existente.</small>`
      : `<p>Entre com CPF e senha para assinar este produto usando uma empresa já cadastrada.</p><form id="subscription-login-form"><label class="form-field"><span class="form-label">CPF</span><input id="subscription-login-cpf" name="cpf" inputmode="numeric" autocomplete="username" required><span class="field-error" id="subscription-login-cpf-error" role="alert"></span></label><label class="form-field"><span class="form-label">Senha</span><input name="password" type="password" autocomplete="current-password" required></label><button class="btn btn-green" type="submit">Entrar e continuar</button></form><p id="account-feedback" role="status"></p><small>Se sua conta possuir mais de uma empresa, você escolherá qual delas será usada antes de continuar.</small>`;
